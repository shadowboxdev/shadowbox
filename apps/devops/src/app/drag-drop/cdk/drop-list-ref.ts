...
export class DropListRef<T = any> {
  ...
  protected _itemPositions: CachedItemPosition[] = [];
   ...
   * been dropped yet.
   */
  protected _activeDraggables: DragRef[];
   ...
   */
  protected _previousSwap: any = {drag: null as DragRef | null, delta: 0, overlaps: false};

  /** Draggable items in the container. */
  protected _draggables: ReadonlyArray<DragRef>;

  /** Drop lists that are connected to the current one. */
  protected _siblings: ReadonlyArray<DropListRef> = [];

  /** Direction in which the list is oriented. */
  protected _orientation: 'horizontal' | 'vertical' = 'vertical';

  /** Connected siblings that currently have a dragged item. */
  protected _activeSiblings = new Set<DropListRef>();
  ...
  protected _verticalScrollDirection = AutoScrollVerticalDirection.NONE;

  /** Horizontal direction in which the list is currently scrolling. */
  protected _horizontalScrollDirection = AutoScrollHorizontalDirection.NONE;

  /** Node that is being auto-scrolled. */
  protected _scrollNode: HTMLElement | Window;

  /** Used to signal to the current auto-scroll sequence when to stop. */
  protected _stopScrollTimers = new Subject<void>();
   ...
   */
  protected _getItemIndexFromPointerPosition(item: DragRef, pointerX: number, pointerY: number,
