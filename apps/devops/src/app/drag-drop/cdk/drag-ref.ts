...
export class DragRef<T = any> {
  ...
  protected _previewRef: EmbeddedViewRef<any> | null;

  /** Reference to the view of the placeholder element. */
  protected _placeholderRef: EmbeddedViewRef<any> | null;
  ...
  protected _pickupPositionOnPage: Point;

  /**
   * Anchor node used to save the place in the DOM where the element was
   * picked up so that it can be restored at the end of the drag sequence.
   */
  protected _anchor: Comment;
   ...
   */
  protected _passiveTransform: Point = {x: 0, y: 0};

  /** CSS `transform` that is applied to the element while it's being dragged. */
  protected _activeTransform: Point = {x: 0, y: 0};

  /** Inline `transform` value that the element had before the first dragging sequence. */
  protected _initialTransform?: string;

  /**
   * Whether the dragging sequence has been started. Doesn't
   * necessarily mean that the element has been moved.
   */
  protected _hasStartedDragging: boolean;

  /** Whether the element has moved since the user started dragging it. */
  protected _hasMoved: boolean;

  /** Drop container in which the DragRef resided when dragging began. */
  protected _initialContainer: DropListRef;

  /** Index at which the item started in its initial container. */
  protected _initialIndex: number;

  /** Cached positions of scrollable parent elements. */
  protected _parentPositions: ParentPositionTracker;

  /** Emits when the item is being moved. */
  protected _moveEvents = new Subject<{
    source: DragRef;
  ...
  protected _pointerDirectionDelta: {x: -1 | 0 | 1, y: -1 | 0 | 1};

  /** Pointer position at which the last change in the delta occurred. */
  protected _pointerPositionAtLastDirectionChange: Point;

  /** Position of the pointer at the last pointer event. */
  protected _lastKnownPointerPosition: Point;
   ...
   */
  protected _ownerSVGElement: SVGSVGElement | null;

  /**
   * Inline style value of `-webkit-tap-highlight-color` at the time the
   * dragging was started. Used to restore the value once we're done dragging.
   */
  protected _rootElementTapHighlight: string;

  /** Subscription to pointer movement events. */
  protected _pointerMoveSubscription = Subscription.EMPTY;

  /** Subscription to the event that is dispatched when the user lifts their pointer. */
  protected _pointerUpSubscription = Subscription.EMPTY;

  /** Subscription to the viewport being scrolled. */
  protected _scrollSubscription = Subscription.EMPTY;
   ...
   */
  protected _lastTouchEventTime: number;

  /** Time at which the last dragging sequence was started. */
  protected _dragStartTime: number;

  /** Cached reference to the boundary element. */
  protected _boundaryElement: HTMLElement | null = null;

  /** Whether the native dragging interactions have been enabled on the root element. */
  protected _nativeInteractionsEnabled = true;

  /** Cached dimensions of the preview element. */
  protected _previewRect?: ClientRect;

  /** Cached dimensions of the boundary element. */
  protected _boundaryRect?: ClientRect;

  /** Element that will be used as a template to create the draggable item's preview. */
  protected _previewTemplate?: DragPreviewTemplate | null;

  /** Template for placeholder element rendered to show where a draggable would be dropped. */
  protected _placeholderTemplate?: DragHelperTemplate | null;

  /** Elements that can be used to drag the draggable item. */
  protected _handles: HTMLElement[] = [];

  /** Registered handles that are currently disabled. */
  protected _disabledHandles = new Set<HTMLElement>();

  /** Droppable container that the draggable is a part of. */
  protected _dropContainer?: DropListRef;

  /** Layout direction of the item. */
  protected _direction: Direction = 'ltr';
   ...
   */
  protected _endDragSequence(event: MouseEvent | TouchEvent) {
   ...
   */
  protected _updateActiveDropContainer({x, y}: Point, {x: rawX, y: rawY}: Point) {
   ...
   */
  protected _animatePreviewToPlaceholder(): Promise<void> {
  ...
  protected _getConstrainedPointerPosition(point: Point): Point {
  ...
  protected _updatePointerDirectionDelta(pointerPositionOnPage: Point) {
  ...
  protected _toggleNativeDragInteractions() {
  ...
  protected _removeRootElementListeners(element: HTMLElement) {
   ...
   */
  protected _applyRootElementTransform(x: number, y: number) {
   ...
   */
  protected _getDragDistance(currentPosition: Point): Point {
  ...
  protected _cleanupCachedDimensions() {
    this._boundaryRect = this._previewRect = undefined;
    this._parentPositions.clear();
  }
   ...
   */
  protected _containInsideBoundaryOnResize() {
  ...
  protected _getDragStartDelay(event: MouseEvent | TouchEvent): number {
  ...
  protected _updateOnScroll(event: Event) {
  ...
  protected _getViewportScrollPosition() {
