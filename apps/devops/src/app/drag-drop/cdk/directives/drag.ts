...
export class CdkDrag<T = any> implements AfterViewInit, OnChanges, OnDestroy {
   ...
   * has been found.
   */
  @Input('cdkDragBoundary') boundaryElement:
    | string
  ...
  @Output('cdkDragStarted') started: EventEmitter<
    CdkDragStart
  ...
  @Output('cdkDragEnded') ended: EventEmitter<CdkDragEnd> = new EventEmitter<
    CdkDragEnd
  >();
   ...
   */
  @Output('cdkDragMoved') moved: Observable<CdkDragMove<T>> = new Observable(
  ...
  constructor(
    ...
    private _selfHandle?: CdkDragHandle
  ) {
  ...
  private _getBoundaryElement() {
    ...
    if (isDevMode && !element.contains(this.element.nativeElement)) {
      throw Error(
        'Draggable element is not inside of the node passed into tsvDragBoundary.'
      );
    }
